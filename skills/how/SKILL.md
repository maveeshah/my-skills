...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `opus`, `fable`, `sonnet`), all in a single message.
...
Same framework as the **review** skill. You're a pragmatic lead, not an aggregator.
