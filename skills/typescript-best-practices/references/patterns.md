...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic; see the **type-system-discipline** and **boundary-discipline** principle (`principles/boundary-discipline.md`)s.
...
Validate once where data crosses in; trust types inside. See the **boundary-discipline** principle (`principles/boundary-discipline.md`).
