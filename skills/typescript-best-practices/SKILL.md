...
Apply the **type-system-discipline** principle (`principles/type-system-discipline.md`) first; this skill grounds it in TypeScript syntax.
...
| Boundary validation | Validate where data crosses in; trust types inside. See the **boundary-discipline** principle (`principles/boundary-discipline.md`). |
