...
1. Identify the format and load it with the right tool. Parse large artifacts in a subagent (the **guard-the-context-window** principle (`principles/guard-the-context-window.md`) skill) and keep the reduced finding in the main thread.
