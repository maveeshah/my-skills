...
description: "Orchestrate comprehensive content research across X, Instagram, YouTube, and TikTok platforms. Runs research skills in parallel via subagents, then aggregates findings into actionable content plans and platform-specific intelligence playbooks. Triggers: content plan, content planner, research all platforms, comprehensive research, content strategy, multi-platform research, create playbooks, aggregate research."
---
...
Use the Agent tool to launch 4 subagents simultaneously:
...
2. Launch 4 research subagents in parallel (Agent tool with 4 invocations)
